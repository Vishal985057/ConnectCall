  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", flexDirection:"column", background:"#202124" }}>
      ...
      <nav style={{
        ...
        <div className="landing-nav-btns" style={{ display:"flex", gap:8 }}>
          <Link to="/auth" className="btn btn-ghost"
            style={{ padding:"9px 16px", fontSize:14, borderRadius:4 }}>Sign in</Link>
          <Link to="/auth" className="btn btn-blue"
            style={{ padding:"9px 16px", fontSize:14, borderRadius:4 }}>Get started free</Link>
        </div>
      </nav>
      ...
      <main style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center",
        ...
        <h1 style={{ fontFamily:"var(--font)", fontWeight:400, color:"#e8eaed",
          fontSize:"clamp(28px,6vw,60px)", lineHeight:1.15, maxWidth:700, marginBottom:20 }}>
        ...
        <div style={{ display:"flex", flexWrap:"wrap", gap:12, justifyContent:"center" }}>
          <Link to="/auth" className="btn btn-blue"
            style={{ padding:"14px 28px", fontSize:16, borderRadius:4 }}>
        ...
        <div style={{
          ...
          gap:14, maxWidth:800, width:"100%", marginTop:64,
        }}>
          {[
      ...
      <footer style={{ textAlign:"center", padding:"16px 20px",
